// https://docs.github.com/es/webhooks/using-webhooks/validating-webhook-deliveries
...
export class GitHubSha256Middleware {
  ...
  public static async verifyGithubSignature(req: Request, res: Response, next: NextFunction) {
